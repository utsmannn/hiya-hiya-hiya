 ...
 * bottom sheet.
 */
public class BottomSheetBehaviorRv<V extends View> extends CoordinatorLayout.Behavior<V> implements ICustomBottomSheetBehavior<V> {
    ...
    public BottomSheetBehaviorRv() {}

    public BottomSheetBehaviorRv(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, BottomSheetBehaviorRv behavior) {
            super(superState);
    ...
    /**
     * A utility function to get the {@link BottomSheetBehaviorRv} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetBehaviorRv}.
     * @return The {@link BottomSheetBehaviorRv} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetBehaviorRv<V> from(V view) {
        ViewGroup.LayoutParams params = view.getLayoutParams();
        if (!(params instanceof LayoutParams)) {
            throw new IllegalArgumentException("The view is not a child of CoordinatorLayout");
        }
        CoordinatorLayout.Behavior behavior = ((LayoutParams) params).getBehavior();
        if (!(behavior instanceof BottomSheetBehaviorRv)) {
            throw new IllegalArgumentException("The view is not associated with BottomSheetBehavior");
        }
        return (BottomSheetBehaviorRv<V>) behavior;
    }
